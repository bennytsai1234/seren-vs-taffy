...
export default function Home() {
  return (
    <div className="flex flex-col min-h-[80vh]">
      {/* Hero */}
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-10 relative overflow-hidden">
        {/* VS 背景裝飾 */}
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          {/* Hero SVG */}
          <img
            src="/images/hero-vs.svg"
            alt="東雪蓮 vs 永雛塔菲"
        ...
        <p className="text-center text-lg opacity-60 mb-10">両辺のファン待望の激突！</p>
